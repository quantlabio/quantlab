 ...
 */
export
const ICalendarTools = new Token<ICalendarTools>('jupyter.services.calendar-tools');
/* tslint:enable */
 ...
 */
export
interface ICalendarTools extends CalendarTools {};
 ...
 */
export
class CalendarTools extends Widget {
  /**
   * Construct a new CellTools object.
   */
  constructor(options: CalendarTools.IOptions) {
    super();
   ...
   */
  addItem(options: CalendarTools.IAddOptions): void {
    ...
    //MessageLoop.sendMessage(tool, CalendarTools.ActiveCellMessage);
  }
...
namespace CalendarTools {
  ...
  interface IOptions {
    /**
     * The calendar tracker used by the sheet tools.
     */
    tracker: ICalendarTracker;
  }
   ...
   */
  export
  const SelectionMessage = new ConflatableMessage('calendar-selection-changed');
  ...
  class Tool extends Widget {
     ...
     */
    readonly parent: ICalendarTools;
...
namespace Private {
   ...
   */
  export
  function createSelectorNode(options: CalendarTools.KeySelector.IOptions): HTMLElement {
