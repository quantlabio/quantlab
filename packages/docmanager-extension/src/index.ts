 ...
 */
function addCommands(app: QuantLab, docManager: IDocumentManager, palette: ICommandPalette, opener: DocumentManager.IWidgetOpener): void {
  const { commands } = app;
 ...
 */
function handleContext(app: QuantLab, context: DocumentRegistry.Context): void {
