 ...
 */
function activateHubExtension(app: QuantLab, palette: ICommandPalette, mainMenu: IMainMenu): void {
  ...
  if (!hubPrefix) {
    console.log('quantlab-hub: No configuration found.');
    return;
  }

  console.log('quantlab-hub: Found configuration ',
...
/**
 * Initialization data for the quantlab_hub extension.
 */
const hubExtension: QuantLabPlugin<void> = {
  activate: activateHubExtension,
  id: 'jupyter.extensions.quantlab-hub',
  requires: [
    ICommandPalette,
    IMainMenu,
  ],
